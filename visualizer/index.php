  ...
  <body>
    <div id="container">
      <header>
        <table id="players">
          <tr>
            ...
            <td style="width: 20%; text-align: center" class="playerVs">
              Loading
            </td>
      ...
      <div id="main">
        ...
        <p id="controls">
          <a href="#" id="start-button" title="Jump to start"
            ><span class="small">|</span>&laquo;</a
          >
          |
          <a href="#" id="prev-frame-button" title="Previous frame (left arrow)"
            >&laquo;</a
          >
          | <a href="#" id="play-button" title="Pause (space bar)">&#9654;</a> |
          <a href="#" id="next-frame-button" title="Next frame (right arrow)"
            >&raquo;</a
          >
          |
          <a href="#" id="end-button" title="Jump to end"
            >&raquo;<span class="small">|</span></a
          ><br />
